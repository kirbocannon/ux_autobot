...
# TODO: Prob convert this to better date module
...
class HarParser:
    ...
    @staticmethod
    def create_asset_timeline(asset_list: List["HarEntry"]) -> defaultdict:
        """
        Returns a `defaultdict` of the timeline for the requested assets. The key is
...
class HarPage:
    ...
    def filter_entries(
        ...
        :param receive_time__gt: Receive time in milliseconds. If
            provided, an entry whose receive time is less than this value will
            be excluded from the results.
        :type receive_time__gt: int
        :param regex: Whether to use regex or exact match.
        :type regex: bool
